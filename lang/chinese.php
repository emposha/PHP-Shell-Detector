<?php
  ...
  $local['Please note <strong>openssl</strong> library not found, suspicious files will be included in html without encryption.'] = '请注意：没有发现 <strong>openssl</strong> 扩展库。可疑文件将只包含未被加密的文件。';
  $local['Please note, shells signature database not found, suspicious files will be scan only by behavior.'] = '请注意：未发现 shell 签名数据库。将只通过行为扫描可疑文件。';
